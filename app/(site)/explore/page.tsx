...
export default function ExplorePage() {
  ...
  return (
    <div>
      <p className="text-walnut text-xs uppercase tracking-widest mb-2">Explore Brussels</p>
      ...
      <div className="grid grid-cols-1 lg:grid-cols-3 gap-8">
        ...
        <div className="lg:col-span-2 space-y-12">
          ...
          <section>
            ...
            <div className="grid grid-cols-1 sm:grid-cols-2 md:grid-cols-3 gap-3">
              {LOCAL_CREATORS.map(creator => (
                <div
                  key={creator.handle}
                  className="bg-ivory border border-sand/30 rounded-2xl p-4"
                >
          ...
          <section>
            ...
            <div className="bg-ivory border border-sand/30 rounded-2xl p-6">
          ...
          <section>
            ...
            <div className="grid grid-cols-1 sm:grid-cols-2 gap-3">
              <a
                ...
                target="_blank"
                rel="noopener noreferrer"
                className="bg-ivory border border-sand/30 rounded-2xl p-4 hover:border-terracotta/30 transition-colors group"
              >

...
export default function MapPage() {
  return (
    <div>
      ...
      <div className="rounded-2xl overflow-hidden border border-sand/50 dark:border-night-border">
        <BrusselsMap />
      </div>
      ...
      <div className="mt-4 flex gap-6">
        <div className="flex items-center gap-2">
          ...
          <span className="text-xs text-walnut dark:text-night-muted">Commune centres</span>
        </div>
        <div className="flex items-center gap-2">
          <span className="w-3 h-3 rounded-full bg-walnut inline-block" />
          <span className="text-xs text-walnut dark:text-night-muted">Key landmarks</span>
        </div>
      </div>
    </div>
  )

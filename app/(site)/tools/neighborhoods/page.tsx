  ...
  return (
    <div>
      ...
      <p className="text-walnut text-base max-w-xl mb-8">
        Compare Brussels communes on the factors that matter most.
      </p>
      ...
      <div className="grid grid-cols-1 lg:grid-cols-3 gap-6">
        ...
        <div className="lg:col-span-1">
          <div className="border border-sand/50 rounded-2xl overflow-hidden divide-y divide-sand/50">
              ...
              >
                <div>
                  <p className={cn(
                    ...
                    selected.id === commune.id ? 'text-terracotta' : 'text-espresso'
                  )}>
                    {commune.name}
                  </p>
                  <p className="text-xs text-walnut mt-0.5">{commune.vibe}</p>
                </div>
                <p className="text-sm font-medium text-espresso shrink-0 ml-3">
        ...
        <div className="lg:col-span-2">
          <div className="bg-ivory border border-sand/50 rounded-2xl p-6 sticky top-20">
            <div className="flex items-start justify-between mb-4">
              <div>
                <h2 className="font-display text-2xl font-bold text-espresso">
                  {selected.name}
                </h2>
                <p className="text-walnut text-sm">{selected.vibe}</p>
              </div>
            ...
            <p className="text-espresso text-sm leading-relaxed mb-6">
              {selected.desc}
            </p>
            ...
            <div className="flex gap-3">
              ...
              <a
                href={`/tools/map`}
                className="px-5 py-2.5 border border-espresso/30 text-espresso rounded-full text-sm font-medium hover:bg-sand/50 transition-colors"
              >
                View on map
              </a>
            </div>
